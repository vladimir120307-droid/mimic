  ...
  return (
    <section className="mx-auto max-w-md min-h-screen">
      <div className="flex flex-col gap-2 bg-[#F1F5F9]">
        ...
        <div className="rounded-2xl bg-white shadow-sm p-4 bg-[#FFFFFF] rounded-xl p-3">
          <span>Hey, free for lunch?</span>
        </div>
        <div className="rounded-2xl bg-white shadow-sm p-4 bg-[#0EA5E9] text-[#FFFFFF] rounded-xl p-3">
        ...
        <button type="button" className="fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg flex items-center justify-center bg-[#0EA5E9] text-[#FFFFFF]" aria-label="action"><span className="text-2xl">+</span></button>
      </div>
    </section>
  );
}
