...
PRs welcome. Read [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) before opening one. Good first issues are tagged [`good first issue`](https://github.com/Cyber-Lord/mimic/labels/good%20first%20issue).
