    ...
    <section className="mx-auto max-w-md min-h-screen">
      <div className="flex flex-col gap-2 bg-[#FFFFFF]">
        <div className="w-full px-4 py-3 flex items-center justify-between bg-[#6E56CF] text-[#FFFFFF]">
          <p className="text-[#FFFFFF] text-xl font-bold">mimic</p>
        </div>
        ...
        <button type="button" className="fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg flex items-center justify-center bg-[#6E56CF] text-[#FFFFFF]" onClick={() => onTap("fab")} aria-label="action"><span className="text-2xl">+</span></button>
      </div>
    </section>
  );
}
