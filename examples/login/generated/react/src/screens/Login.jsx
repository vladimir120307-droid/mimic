...
export default function Login() {
  return (
    <section className="mx-auto max-w-md min-h-screen" style={{ backgroundColor: "#F8FAFC" }}>
      <div className="flex flex-col gap-2 bg-[#F8FAFC] p-6">
        <span className="text-[#6E56CF] text-5xl" aria-hidden="true">●</span>
        ...
        <button type="button" className="bg-[#6E56CF] text-[#FFFFFF]">Sign in</button>
        <p className="text-[#6E56CF] text-sm text-center">Don&#x27;t have an account? Create one</p>
      </div>
    </section>
  );
}
